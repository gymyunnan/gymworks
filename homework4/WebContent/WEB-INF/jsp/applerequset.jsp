...
<body>
我的苹果:<br>
Price:${myapple.applePrice}<br>
Name:${myapple.appleName}
</body>
</html> --%>
...
<body>
    ...
    var applePrice = ${myapple.applePrice}; // 获取苹果价格
    var appleName = "${myapple.appleName}"; // 获取苹果名称，必须打双引号，否则会报错
    ...
    var option = {
        ...
        series: [
            {
                name: "苹果单仪表盘示例",     // 系列名称,用于tooltip的显示，legend 的图例筛选，在 setOption 更新数据和配置项时用于指定对应的系列。
                type: "gauge",          // 系列类型
